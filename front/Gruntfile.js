...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      livereload: {
        ...
        files: [
          '<%= frontend.app %>/{,*/}*.html',
          '.tmp/styles/{,*/}*.css',
          '<%= frontend.app %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
        ]
      }
    },
    ...
    wiredep: {
      ...
      sass: {
        src: ['<%= frontend.app %>/styles/{,*/}*.{scss,sass}'],
    ...
    compass: {
      ...
      dist: {
        options: {
          generatedImagesDir: '<%= frontend.dist %>/images/generated'
        }
      },
      server: {
        options: {
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= frontend.dist %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}',
          '<%= frontend.dist %>/styles/fonts/*'
        ]
      }
    },
    ...
    usemin: {
      html: ['<%= frontend.dist %>/{,*/}*.html'],
      css: ['<%= frontend.dist %>/styles/{,*/}*.css'],
      js: ['<%= frontend.dist %>/scripts/{,*/}*.js'],
      options: {
        assetsDirs: [
          '<%= frontend.dist %>',
