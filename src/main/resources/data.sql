...
INSERT INTO message (body, read, recipient_name, sender_name, sent, sent_date, subject, user_username) VALUES ('body', false, 'admin', 'user', false, null, 'subject', 'user')
INSERT INTO message (body, read, recipient_name, sender_name, sent, sent_date, subject, user_username) VALUES ('body', false, 'admin', 'user', false, null, 'subject', 'user' )
INSERT INTO message (body, read, recipient_name, sender_name, sent, sent_date, subject, user_username) VALUES ('hello in app', TRUE, 'user', 'admin', true, CURRENT_DATE, 'Hello', 'user' )
